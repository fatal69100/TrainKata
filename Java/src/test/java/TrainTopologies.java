public class TrainTopologies {
        public static String With10AvailableSeats()
        {
            return "{\"seats\": {" +
        ...
        public static String With10SeatsAnd6AlreadyReserved()
        {
            return "{\"seats\": {" +
        ...
        public static String With2CoachesAndTheFirstCoachIsFull()
        {
            return "{\"seats\": {" +
        ...
        public static String With2CoachesAnd9SeatsAlreadyReservedInTheFirstCoach()
        {
            return "{\"seats\": {" +
        ...
        public static String With10CoachesHalfAvailable()
        {
            return "{\"seats\": {" +
